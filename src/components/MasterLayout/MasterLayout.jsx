  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      subMenu: [
        ...
        {
          title: "New Expense",
          icon: <AiOutlineBank size={16} className="side-bar-subitem-icon" />,
          ...
          <Navbar.Brand>
            <div
              ...
              <h4 className="text-white m-0 p-0">
                <a onClick={MenuBarClickHandler} href={false}>
                  <AiOutlineMenu />
                </a>
              </h4>
            </div>
          ...
          <div className="float-right h-auto d-flex align-items-center">
            <div className="user-dropdown">
              ...
              <div className="user-dropdown-content ">
                ...
                <a onClick={Onlogout} className="side-bar-item" href={false}>
